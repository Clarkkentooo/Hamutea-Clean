import ECash from "@assets/svg/gcash.svg" // Using the same SVG file but renaming the import
            ...
            transactions.map((transaction, index) => (
                <div key={index} className="border rounded-2xl my-4 p-5">
                    <div className="grid grid-cols-8 gap-5 mb-4">
                        ...
                        <div>
                            <img src={transaction.paymentMethod === "E-CASH" ? ECash : Cash} alt={transaction.paymentMethod} className="h-6" />
                        </div>
                        <div>
