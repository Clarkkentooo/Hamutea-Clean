                    ...
                    <div key={orderIndex} className="border rounded-2xl my-4 p-5">
                        {visibleItems.map((item, itemIndex) => (
                            <div key={itemIndex} className="grid grid-cols-9 gap-5 mb-4">
                                ...
                                <div>{itemIndex === 0 ? (
                                    <>
                                        <ActionButton variant={order.status === "completed" ? "success" : "danger"} label={order.status === "completed" ? "Completed" : order.status === "cancelled" ? "Cancelled" : "Processing"} icon="ChevronDown" />
                                    </>
                                ) : ""}</div>
                            </div>
                        ))}
                            ...
                            order.status === "processing" && (
                                <div className="border-t p-5">
                                    ...
                                    <div className="flex justify-between items-start mt-5">
                                        ...
                                        <div>
                                            <button className="border-green-500 text-green-500 text-sm border px-3 py-1 rounded-full flex items-center justify-center bg-[#daffd9]">Mark as Completed</button>
                                        </div>
                                    </div>
                                </div>
                            )
